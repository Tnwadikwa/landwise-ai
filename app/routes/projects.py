...
def _project_summary(project) -> dict:
    ...
    return {
        ...
        "plot_size_sqm": plot["plot_size_sqm"],
        "estimated_units": report["estimated_units"],
        "acquisition_cost_ngn": plot["acquisition_cost_ngn"],
        "construction_cost_ngn": report["construction_cost_ngn"],
        "total_investment_ngn": plot["acquisition_cost_ngn"] + report["construction_cost_ngn"],
        "estimated_profit_ngn": report["projected_gross_revenue_ngn"] - plot["acquisition_cost_ngn"] - report["construction_cost_ngn"],
